...
Page({
  ...
  bindCity: function (e) {
    ...
    wx.setStorageSync("citycode", e.currentTarget.dataset.code)
  ...
  backindex: function () {
    ...
    prevPage.setData({
      currenCity: this.data.city,
      currenCounty: this.data.county,
      'elType': "MY"
    });
    wx.setStorage({
      key: "city",
      data: {
        currenCity: this.data.city,
        currenCounty: this.data.county,
        currentCityCode: this.data.currentCityCode
      },
      success: function () {
        //返回首页
